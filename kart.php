...
<h2>あなたが所持しているマシンを選んでください</h2>
<br/><br/>

<form action="kart_course.php" method="post">
...
foreach ($rec as $item) {
    ...
    print '<li>';
    print '<label>';
    print '<input type="checkbox" name="kart_id[]" value="'.$item['id'].'">';
    print $item['kart'];
    print '<img src="img/'.$item['kart'].'.png">';
    print '</label>';
    print '</li>';
